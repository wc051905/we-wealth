...
import com.chen.common.utils.file.FileUploadUtils;
import com.chen.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult updateAvatar(@RequestParam("avatarfile") MultipartFile file)
    {
        ...
        try
        {
            if (!file.isEmpty())
            {
                String avatar = FileUploadUtils.upload(ChenConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
